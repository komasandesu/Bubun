...
type Module = typeof import("../_app.profile.$username_.favorite.js")

type Info = GetInfo<{
  file: "routes/_app.profile.$username_.favorite.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_app.profile.$username_.favorite.js");
}];
