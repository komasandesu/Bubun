...
type Module = typeof import("../_app.posts._index.js")

type Info = GetInfo<{
  file: "routes/_app.posts._index.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_app.posts.js");
}, {
  id: "routes/_app.posts._index";
  module: typeof import("../_app.posts._index.js");
}];
