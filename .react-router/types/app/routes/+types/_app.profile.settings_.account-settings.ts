...
type Module = typeof import("../_app.profile.settings_.account-settings.js")

type Info = GetInfo<{
  file: "routes/_app.profile.settings_.account-settings.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../_app.profile.settings_.account-settings.js");
}];
