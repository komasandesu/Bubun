...
export async function loader({ params, request }: LoaderFunctionArgs) {
  ...
  const body = JSON.stringify({
    user,
    profileUser: profileUserWithFormattedDate,
  ...
  return (
    <div className="container mx-auto p-6 max-w-3xl bg-gray-100 dark:bg-gray-900">
      <div className="bg-white shadow-md rounded-lg p-6 dark:bg-gray-800 dark:text-gray-100">
        <h1 className="text-2xl font-bold mb-4 text-black dark:text-gray-100">
          {profileUser.name}さんのプロフィール
        </h1>
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-400">
            作成日: {profileUser.createdAt}
          </p>

          <p className="text-gray-600 dark:text-gray-400">
            プロフィール: {profileUser.profile}
          </p>
          <p className="text-gray-600 dark:text-gray-400">
            Twitter:
      ...
      <h2 className="text-xl font-semibold mt-6 text-black dark:text-gray-100">
        投稿一覧
      </h2>
